...
TxLength =length(ytx_mod_filt_up); % Length of transmission. In [0:2^14-1-TxDelay]
...
% Hints: 
% 1. The first argument of the 'warplab_writeSMRO' function identifies the
...
% 2. The second argument of the 'warplab_writeSMRO' function identifies the
...
% 'warplab_readSMRO' function. (Read extra 100 samples to account for 
% jitter in sync trigger)
% Hints:
...
[Node2_Radio2_RawRxData] = warplab_readSMRO(udp_node2, RADIO2_RXDATA, TxLength+TxDelay+100);
